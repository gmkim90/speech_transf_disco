...
net_arg.add_argument('--disallow_resize', type=bool, default=False,
                     help='disallow resize of image')
...
data_arg.add_argument('--grayImage', type=bool, default=False)
...
# Spectrogram hyperparam
data_arg.add_argument('--use_log_magnitude', type=bool, default=False)  # KALDI : (maybe) linear spectrogram magnitude
data_arg.add_argument('--fs', type=int, default=16000)  # CHiME
